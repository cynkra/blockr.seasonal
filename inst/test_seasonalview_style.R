...
# Create a board with the summary block
board <- new_board(
  blocks = c(
...
blockr.core::generate_block_screenshot(
  board,
  file.path("inst", "screenshots", "summary_seasonalview_style.png")
)

message("Screenshot saved to inst/screenshots/summary_seasonalview_style.png")
