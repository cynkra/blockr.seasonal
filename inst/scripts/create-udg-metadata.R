...
metadata_list <- list(
  ...
  list(
    "samode",
    "Basic",
    "Seasonal adjustment mode (mult, add, logadd, pseudoadd)"
  ),
  ...
  list(
    "qsorievadj",
    "QS Test",
    "QS statistic for original series (adjusted for extreme values)"
  ),
  ...
  list(
    "qssadjevadj",
    "QS Test",
    "QS statistic for seasonally adjusted series (adjusted for extreme values)"
  ),
  list("qsirr", "QS Test", "QS statistic for irregular component"),
  list(
    "qsirrevadj",
    "QS Test",
    "QS statistic for irregular component (adjusted for extreme values)"
  ),
  ...
  list(
    "f3.m01",
    "M-Stat",
    "M1: Relative contribution of irregular to stationary portion"
  ),
  list(
    "f3.m02",
    "M-Stat",
    "M2: Relative contribution of irregular to trend-cycle"
  ),
  list(
    "f3.m03",
    "M-Stat",
    "M3: Amount of period-to-period change in irregular"
  ),
  ...
  list(
    "f3.m10",
    "M-Stat",
    "M10: Size of fluctuations in seasonal compared to irregular"
  ),
  list(
    "f3.m11",
    "M-Stat",
    "M11: Size of fluctuations in irregular compared to seasonal"
  ),
  ...
  list(
    ...
    "AIC Test",
    "AICc without log transformation"
  ),
...
udg_metadata <- udg_metadata[
  order(udg_metadata$category, udg_metadata$statistic),
]
